...
while (restartGame){
  ...
  // Using parseInt to attempt to convert the user's response into a number value because prompts automatically uses strings
  rangeNum = parseInt(rangeNum);

  // Verifies the user's entry for a range number is a number greater than zero (NOTE: All numbers, positive or negative, have default boolean value of true, except for zero which has a default boolean value of false. Also, NaN has a default boolean value of false as well.)
  ...
  while (true){
    ...
    if (playAgain.toUpperCase() === `N`){
      ...
      //if (playAgain === `N` || `n`)
      // or 
      // (playAgain === ('N') || playAgain === ('n') || playAgain === ('no') || playAgain === ('No'))
      ...
      //if (playAgain === `Y` || `y`)
      //or
      //(playAgain === ('Y') || playAgain === ('y') || playAgain === ('yes') || playAgain === ('Yes'))
      // The game restarts
      break;
